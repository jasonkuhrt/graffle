...
// node_modules/.pnpm/vitepress@1.3.4_@algolia+client-search@5.2.5_@types+node@22.5.4_postcss@8.4.45_search-insights@2.17.1_typescript@5.5.4/node_modules/vitepress/lib/vue-demi.mjs
var isVue2 = false
var isVue3 = true
...
// node_modules/.pnpm/@vueuse+shared@11.0.3_vue@3.5.2_typescript@5.5.4_/node_modules/@vueuse/shared/index.mjs
...
// node_modules/.pnpm/@vueuse+core@11.0.3_vue@3.5.2_typescript@5.5.4_/node_modules/@vueuse/core/index.mjs
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (config.payload) {
      ...
      if (
        !config.payloadType && payload && Object.getPrototypeOf(payload) === Object.prototype
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (!key) {
    if (isVue2) {
      const modelOptions = (_e = (_d = vm == null ? void 0 : vm.proxy) == null ? void 0 : _d.$options) == null
        ? void 0
        : _e.model
...
function useVirtualList(list, options) {
  const { containerStyle, wrapperProps, scrollTo: scrollTo2, calculateRange, currentList, containerRef } =
...
vitepress/lib/vue-demi.mjs:
   ...
   *)
*/
// # sourceMappingURL=chunk-T7NZPC24.js.map
