import { useMediaQuery } from './chunk-T7NZPC24.js'
import { computed, ref, shallowRef, watch } from './chunk-X6KM7CKJ.js'
...
function serializeHeader(h) {
  ...
  for (const node of h.childNodes) {
    if (node.nodeType === 1) {
      if (
        node.classList.contains('VPBadge') || node.classList.contains('header-anchor')
