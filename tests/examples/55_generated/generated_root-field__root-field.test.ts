...
test(`generated_root-field__root-field`, async () => {
  const exampleResult = await runExample(`./examples/55_generated/generated_root-field__root-field.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_generated/generated_root-field__root-field.output.txt`,
  )
})
