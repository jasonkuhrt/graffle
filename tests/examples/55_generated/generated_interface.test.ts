...
test(`generated_interface`, async () => {
  const exampleResult = await runExample(`./examples/55_generated/generated_interface.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_generated/generated_interface.output.txt`,
  )
})
