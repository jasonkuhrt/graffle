...
test(`generated_alias`, async () => {
  const exampleResult = await runExample(`./examples/55_generated/generated_alias.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_generated/generated_alias.output.txt`,
  )
})
