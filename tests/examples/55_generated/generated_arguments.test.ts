...
test(`generated_arguments`, async () => {
  const exampleResult = await runExample(`./examples/55_generated/generated_arguments.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_generated/generated_arguments.output.txt`,
  )
})
