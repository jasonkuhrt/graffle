...
test(`generated_document`, async () => {
  const exampleResult = await runExample(`./examples/55_generated/generated_document.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_generated/generated_document.output.txt`,
  )
})
