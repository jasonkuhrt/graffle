...
test(`generated_arguments__arguments`, async () => {
  const exampleResult = await runExample(`./examples/50_generated/generated_arguments__arguments.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/50_generated/generated_arguments__arguments.output.txt`,
  )
})
