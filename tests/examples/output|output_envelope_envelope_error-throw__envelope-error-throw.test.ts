...
test(`output|output_envelope_envelope_error-throw__envelope-error-throw`, async () => {
  const exampleResult = await runExample(
    `./examples/output|output_envelope_envelope_error-throw__envelope-error-throw.ts`,
  )
