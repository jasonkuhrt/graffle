 ...
 */
{
  [Key in keyof $Object as `${keyof OmitArgs<$Object> &
    string}_as_${NonEmptyString}`]?: SelectionSetField<
    Schema.AsField<$Object[Key]>,
    $Index
  >
} & FieldDirectives & /**
