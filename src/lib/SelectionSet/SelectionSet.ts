...
type SelectionSetObject<$Object extends Schema.Object, $Index extends Schema.Index> =
  & {
    [Key in keyof $Object]?: SelectionSetField<Schema.AsField<$Object[Key]>, $Index>
  }
  /**
   * Alias support.
   ...
   */
  & {
    [Key in keyof $Object as `${keyof OmitArgs<$Object> & string}_as_${NonEmptyString}`]?: SelectionSetField<
...
// dprint-ignore
export type SelectionSetField<$Field extends Schema.Field, $Index extends Schema.Index> =
$Field extends Schema.ScalarField 	  ? Indicator<$Field> :
$Field extends Schema.unionField 	    ? SelectionSetUnion<$Field['type'], $Index> :
$Field extends Schema.ObjectField 	  ? SelectionSetObject<$Field['type'], $Index> & Arguments<$Field> :
...
type SelectionSetUnion<$Object extends Schema.Union, $Index extends Schema.Index> =
  & {
...
$FieldType['args'] extends Schema.Args ? $FieldType['args']['allOptional'] extends true  ? ({ $?: $FieldType['args']['type'] } & FieldDirectives) | ClientIndicator
