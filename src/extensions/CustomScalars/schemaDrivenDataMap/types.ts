...
export type SchemaDrivenDataMap = GraffleTypes.SchemaDrivenDataMap

export type OutputObject = GraffleTypes.SchemaDrivenDataMap.OutputObject

export type OutputField = GraffleTypes.SchemaDrivenDataMap.OutputField

export type InputObject = GraffleTypes.SchemaDrivenDataMap.InputObject

export type Enum = GraffleTypes.SchemaDrivenDataMap.Enum

export type ArgumentsOrInputObjectFields = GraffleTypes.SchemaDrivenDataMap.ArgumentsOrInputObjectFields

export type Scalar = SchemaScalar.Scalar

export type ArgumentOrInputField = GraffleTypes.SchemaDrivenDataMap.ArgumentOrInputField
...
export const isOutputField = (
  node?: Node,
): node is GraffleTypes.SchemaDrivenDataMap.OutputField => {
