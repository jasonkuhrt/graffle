import { type OperationTypeNameAll, RootTypeName, RootTypeNameToOperationName } from '../../lib/graphql.js'
...
export type DocumentObject = {
  query?: Record<string, SelectionSet.ObjectLike>
  mutation?: Record<string, SelectionSet.ObjectLike>
}
